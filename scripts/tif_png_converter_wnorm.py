...
def main():
    ...
    for path_in in paths:
        ...
        path_out = os.path.join(parent_dir, "resources/out/cytpix/", str(path_out_folder_name))
        ...
        for img_name in tqdm(images):
            ...
            if img is None:
                ...
                continue
            gray = cv2.normalize(img, None, alpha=0, beta=255, 
            ...
            new_image_size = 64
            rotated_cropped = image_rotate_crop(ext_border, valid_contours[0], new_image_size)
